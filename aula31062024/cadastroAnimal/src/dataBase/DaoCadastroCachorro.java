...
public class DaoCadastroCachorro {
  ...
  return deletarCachorro(doc);
	...
	public boolean alterarCachorro(Cachorro cachorro) {
		...
		String comandoSqlUpdate = "UPDATE cd_cachorro SET nome = ?, cor_pelo = ? WHERE doc = ? "; 
		...
		try {
			...
			preparedStatement.setString(1, cachorro.getNome());
			preparedStatement.setString(3, cachorro.getDoc()); 
			preparedStatement.setString(2, cachorro.getCorPelo());
