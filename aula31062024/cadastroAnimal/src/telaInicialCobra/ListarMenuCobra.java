...
public class ListarMenuCobra {
	...
	ControllerLista controllerLista = new ControllerLista(frameListarCobra,iputCobra);
	button.addActionListener(controllerLista);
	gerarPdfCobra.addActionListener(controllerLista);
